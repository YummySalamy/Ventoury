...
import { Package, Clock, DollarSign, Tag, ImageIcon, Calendar, TrendingUp, ShoppingCart } from "lucide-react"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                {product.image_url ? (
                  ...
                  <div className="w-full h-64 rounded-lg bg-neutral-100 flex items-center justify-center">
                ...
                {history.map((entry, index) => (
                  <div key={index} className="flex gap-4">
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-neutral-900 to-neutral-700 flex items-center justify-center text-white">
                    ...
                    <div className="flex-1">
                      ...
                      {entry.sale_id && (
                        <a
                          href={`/app/sales/history?sale=${entry.sale_id}`}
                          className="text-xs text-blue-600 hover:underline mt-1 inline-block"
                        >
                          {t("products.history.viewSale")} →
                        </a>
                      )}
                    </div>
                  </div>
