              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-neutral-200">
                    ...
                    <th className="text-left py-3 sm:py-4 px-2 sm:px-4 font-semibold text-neutral-900 text-xs sm:text-sm hidden md:table-cell">
                      Category
                    </th>
                    <th className="text-left py-3 sm:py-4 px-2 sm:px-4 font-semibold text-neutral-900 text-xs sm:text-sm">
                      Stock
                    ...
                    <th className="text-left py-3 sm:py-4 px-2 sm:px-4 font-semibold text-neutral-900 text-xs sm:text-sm hidden lg:table-cell">
                      Status
                    </th>
                    <th className="text-left py-3 sm:py-4 px-2 sm:px-4 font-semibold text-neutral-900 text-xs sm:text-sm">
                      Actions
                ...
                <tbody>
                  {products.map((product, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 sm:py-4 px-2 sm:px-4 text-xs sm:text-sm text-neutral-600 group-hover:text-neutral-300 transition-colors hidden md:table-cell">
                        {product.category}
                      </td>
                      <td className="py-3 sm:py-4 px-2 sm:px-4 text-xs sm:text-sm text-neutral-600 group-hover:text-neutral-300 transition-colors">
                        {product.stock}
                      ...
                      <td className="py-3 sm:py-4 px-2 sm:px-4">
                        <div className="flex gap-1 sm:gap-2">
                          ...
                          <button className="p-1.5 sm:p-2 hover:bg-red-500 rounded-lg transition-colors group-hover:text-white">
